...
import { AiFillBook, AiOutlineTeam, AiOutlineDollarCircle, AiOutlineGlobal } from "react-icons/ai";
import "../../index.css"
...
const ScholarshipBenefits = () => {
    ...
    return (
        ...
        <section className='lg:px-5 pb-24'>
            <h2
                data-aos="fade-up"
                className="w-full text-3xl md:text-4xl font-bold uppercase tracking-wide text-center lg:text-right mb-4"
            >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 px-3 lg:px-0">
                ...
                <>
                    <div className="grid gap-4 col-wid h-fit">
                        <div
                            data-aos="fade-down"
                            className=" text-justify w-[100%] p-2 rounded-lg border-amber-600 border flex flex-col gap-2"
                        >
                            <h1 className="flex items-center gap-2 font-semibold uppercase text-lg text-left underline underline-offset-4
 dark-text ">
                                <AiFillBook className=" font-bold text-2xl" />
                        ...
                        <div data-aos="zoom-in" className=" h-fit">
                            <img
                                className="h-auto w-[100%] rounded-lg border-[2px] border-gray-100"
                                src="https://images.pexels.com/photos/8199166/pexels-photo-8199166.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                                alt=""
                            />
                        </div>
                    </div>
                    ...
                    <div className="grid gap-4 col-wid h-fit">
                        <div data-aos="zoom-in" className=" h-fit">
                            <img
                                className="h-auto w-[100%] rounded-lg border-[2px] border-gray-100"
                                src="https://images.unsplash.com/photo-1685401704618-fd8243812ef7?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90oy1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                                alt=""
                            />
                        </div>
                        <div
                        ...
                        >
                            <h1 className="flex items-center gap-2 font-semibold uppercase text-lg text-left underline underline-offset-4
 dark-text ">
                                <AiOutlineTeam className="font-bold text-2xl" />
                                Mentorship Programs:
                            </h1>
                            <p className=" text-sm leading-relaxed text-gray-800">
                    ...
                    <div className="grid gap-4 col-wid h-fit">
                        <div data-aos="zoom-in" className=" h-fit">
                            <img
                                className="h-auto w-[100%] rounded-lg border-[2px] border-gray-100"
                                src="https://images.pexels.com/photos/3747505/pexels-photo-3747505.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                                alt=""
                            />
                        </div>
                        <div
                        ...
                        >
                            <h1 className="flex items-center gap-2 font-semibold uppercase text-lg text-left underline underline-offset-4
 dark-text ">
                                <AiOutlineDollarCircle className=" font-bold text-2xl" />
                    ...
                    <div className="grid gap-4 col-wid h-fit">
                        ...
                        >
                            <h1 className="flex items-center gap-2 font-semibold uppercase text-lg text-left underline underline-offset-4
 dark-text ">
                                <AiOutlineGlobal className=" font-bold text-2xl" />
                        ...
                        <div data-aos="zoom-in" className=" h-fit">
                            <img
                                className="h-auto w-[100%] rounded-lg border-[2px] border-gray-100"
                                src="https://images.pexels.com/photos/8199625/pexels-photo-8199625.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                                alt=""
                            />
                        </div>
                    </div>
