      ...
      <section className="container px-5 lg:px-7 py-24 mx-auto">
        <div className="flex justify-center flex-wrap w-full mb-20 lg:mb-0">
          <div className="lg:w-[55%] w-full mb-4 lg:mb-0">
            <h1 className="sm:text-4xl text-3xl font-bold title-font mb-2 dark-text">
            ...
            <div className="w-full mx-auto flex flex-wrap justify-center lg:justify-start">
              <div className="flex flex-wrap w-[90%] justify-around py-10">
                <div className="md:p-2 p-1 w-1/2">
                  <img alt="gallery" className="w-full h-auto object-center block border-[6px] border-dark" src="https://img.freepik.com/free-photo/team-meeting-startups_23-2148898711.jpg?t=st=1744041368~exp=1744044968~hmac=920388a33552d412f03a882b2458865b20b7e6bcda274148c0c3337878c9140c&w=740"
                    data-aos="fade-up" />
                </div>
                <div className="md:p-2 p-1 w-1/2 mt-20 ">
                  <img alt="gallery" className="w-full h-auto object-center block border-[6px] border-dark" src="https://img.freepik.com/free-photo/professor-lecturing-students-classroom_23-2151932839.jpg?t=st=1744041427~exp=1744045027~hmac=20e59ead47b805a9cada90f0fb54e25ea7cfe6d053997eb6704ba0e15e151492&w=740"
                    data-aos="fade-up" />
                </div>
    ...
    <div className="flex -space-x-4 rtl:space-x-reverse">
      {universityImages.map((item, idx) => (
        ...
        >
          ...
          {onHover === idx && (
            <div className="absolute top-full left-1/2 -translate-x-1/2 mt-3 w-56 p-4 bg-white dark-text dark:bg-gray-800 rounded-lg shadow-xl z-10 animate-fadeIn border">
              <img
                src={item.src}
                alt={item.title}
